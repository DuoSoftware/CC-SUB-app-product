...
//(function($angular) {
var directiveLibraryModule = angular.module('directivelibrary',['uiMicrokernel', 'angularMoment']);
...
*/	
   ...
   directiveLibraryModule.run(["$templateCache", function($templateCache) {
	...
	directiveLibraryModule.controller('mdcDatePickerController', ['$scope', '$timeout', '$mdDialog', '$document', 'model', 'locale', 'mdTheme', function ($scope, $timeout, $mdDialog, $document, model, locale, mdTheme) {
...
directiveLibraryModule.controller('mdcDatePickerInputController',['$scope', '$attrs', '$timeout', '$mdDialog', function ($scope, $attrs, $timeout, $mdDialog) {
    if (angular.isDefined($scope.model)) {
      $scope.selected = {
        model: moment($scope.model).format('LL'),
        date: $scope.model
...
*/
/*
 _____  _  _      _____   ____  _  ____  _  __ _____ ____    ____  _____  ____  ____  _____ 
/__ __\/ \/ \__/|/  __/  /  __\/ \/   _\/ |/ //  __//  __\  / ___\/__ __\/  _ \/  __\/__ __\
  / \  | || |\/|||  \    |  \/|| ||  /  |   / |  \  |  \/|  |    \  / \  | / \||  \/|  / \  
  | |  | || |  |||  /_   |  __/| ||  \_ |   \ |  /_ |    /  \___ |  | |  | |-|||    /  | |  
  \_/  \_/\_/  \|\____\  \_/   \_/\____/\_|\_\\____\\_/\_\  \____/  \_/  \_/ \|\_/\_\  \_/  
*/
directiveLibraryModule.directive("uiTimepicker", ["moment", function (moment) {
	return {
		restrict: "EA",
...
/*
 _____    _      _____   ____  _  ____  _  __ _____ ____    _____ _      ____ 
/__ __\/ \/ \__/|/  __/  /  __\/ \/   _\/ |/ //  __//  __\  /  __// \  /|/  _ \
  / \  | || |\/|||  \    |  \/|| ||  /  |   / |  \  |  \/|  |  \  | |\ ||| | \|
  | |  | || |  |||  /_   |  __/| ||  \_ |   \ |  /_ |    /  |  /_ | | \||| |_/|
  \_/  \_/\_/  \|\____\  \_/   \_/\____/\_|\_\\____\\_/\_\  \____\\_/  \|\____/ 
*/
/*
...
*/
	...
	*/
	...
	directiveLibraryModule.directive('sglclick', ['$parse', function($parse) {
		return {
			restrict: 'A',
